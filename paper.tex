...
\author{Mario Garcia Valdez\inst{1}, Amaury Hernandez Aguila\inst{1}, Juan-J. Merelo\inst{2} and Alejandra Mancilla Soto\inst{1}}
\institute{ Dept. of Graduate Studies, Instituto Tecnologico de Tijuana (Mexico)\\
    \email{\tt mario@tectijuana.edu.mx}
\and
Geneura Team and CITIC, University of Granada (Spain)\\
...
selecting an appropriate programing exercise, experienced instructors gage a
