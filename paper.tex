...
selection module % which one? - JJ
as part of the process. A genetic algorithm was used in the
user selection module. % Which one? You really have to be _way_ more
...
13 features. The performance of the classifiers is shown in Table \ref{tab_performance}. 

%Start with a reference to the Table (and check numbering) - JJ
The results obtained with this method are satisfactory, considering a free-text
was used. % don't get this. What free text? A program? - JJ
