...
\title{Mining of Keystroke and Mouse Dynamics to Enhance Student Engagement with Programming Assignments}
...
\keywords{Affective computing, neural networks, machine learning}

\abstract{
When choosing from a collection of programming assignments, instructors must
gauge the student\'s affective state and skills to select a learning resource
with the appropriate level of difficulty. This work is
focused on capturing and pre-processing of data for the evaluation of several
machine learning techniques aim at classifing the affective
states of users with different levels of expertise
when learning a new programming language.
Currently, web-based platform is applied to collect data from the students\'
interactions whith programming excersises. The aim of this research is to
evaluate the use of keyboard and mouse dynamics as an appropriate
non-obtrusive sensory input for an affective aware system.
Feature vectors were obtained by pre-processing
data from keyboard and mouse dynamics captured from students as
they were coding basic Python programming assignments.
Feature vectors were used for the classification of five affective states:
...
tree indiction algorithm). The best accuracy was around 75\% and was achieved
...
Programming courses are often regarded as difficult \cite{robins2003learning, lahtinen2005study}
and there is a common conception that they often have a high
failure rate \cite{bennedsen2007failure}. Jenkins \cite{jenkins2001motivation} argues that this lack of success has multiple factors:
\begin{itemize}
...
their proposed solution in a particular language; in order to do this, they
must write the code,
some times compile it, to finally run it to see how it works. This cycle is
often repeated many times, and studens can change their affective state
accordingly.
Data can be collected, while students are working on their assignments.
All the dynamics of actually writing the code using the keyboard for instance
...
compiling errors, exceptions, among others. Data mining of all these data could
