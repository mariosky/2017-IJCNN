...
non-obtrusive sensory input for an affective aware system, and is
motivated by the lack of tools and methodologies for taking into
account the affective state of the student in learning
environments. In an ideal situation, when instructors have to choose
from 
  a collection of programming assignments, they should consider the
