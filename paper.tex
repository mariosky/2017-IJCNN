...
in different ways. In the wider context of the detection of emotions and affective
...
And in order to do that, we will use the dynamic of the learning environment itself. In programming courses, students solve assignments by implementing
their solution in a particular language; in order to do this, they
must type the code, run it directly or by compiling it to check its results. This cycle can be repeated many times, and as they are in this cycle,
...
All the dynamics of actually typing the code and ILE feedback received
by students, the
...
frustration. For the initial experiment 
...
assignment.
% in this experiment we will also use... - JJ
